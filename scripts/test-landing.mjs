...
const styles = readFileSync('landing-premium.css', 'utf8');
...
test('uses liquid background forms and a metallic hero treatment', /class="liquid-field"/.test(landing) && /class="liquid liquid-one"/.test(landing) && /@keyframes liquid-drift-one/.test(styles) && /@keyframes metal-sheen/.test(styles));
